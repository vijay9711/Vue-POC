...
<script>
export default {
  props: ["label", "img", "buttonStyle", "ImgSrc", "buttonClass"],
  methods: {
    buttonClick() {
      console.log("clicked");
    ...
    getStyle() {
      ...
      switch (this.buttonStyle) {
        ...
        case "login":
          return "background: #fff; text-transform: capitalize; border:transparent;height:2.5rem; min-width: 8rem; border-radius: 5px;  color:#17a2b8;box-shadow: 6px 7px 16px 0px rgba(0,0,0,0.75);";
        default:
