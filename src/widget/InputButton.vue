  ...
  methods: {
    ...
    getStyle() {
      ...
      switch (this.buttonStyle) {
        ...
        case "login":
          return "background: #fff; text-transform: capitalize; border:transparent;height:2.5rem; min-width: 8rem; border-radius: 5px;  color:#17a2b8;box-shadow: 5px 8px 9px 0px rgba(64, 64, 64, 1);";
        default:
